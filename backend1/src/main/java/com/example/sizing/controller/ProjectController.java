...
public class ProjectController {
    ...
    public ResponseEntity<Project> forward(@PathVariable String id) {
        log.info("POST /api/projects/{}/forward - Forwarding project for approval", id);
        Project forwarded = projectService.forwardProject(id);
