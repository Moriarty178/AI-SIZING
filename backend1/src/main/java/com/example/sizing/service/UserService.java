...
public class UserService {
    ...
    public User create(CreateUserRequest request) {
        ...
        activityLogService.record(
            ...
            saved.getId(),
            saved.getUsername(),
            "Tạo user mới: role=" + saved.getRole() + ", email=" + saved.getEmail() + ", phone=" + saved.getPhoneNumber()
        );
        return saved;
    }
    ...
    public User update(String id, CreateUserRequest request) {
        ...
        activityLogService.record(
                ...
                saved.getId(),
                saved.getUsername(),
                "Cập nhật user: role=" + saved.getRole() + ", email=" + saved.getEmail() + ", phone=" + saved.getPhoneNumber()
        );
        return saved;
    }
