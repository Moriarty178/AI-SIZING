...
function addCustomInputConfigRow() {
    ...
    tr.innerHTML = `
        ...
        <td><input type="number" class="input-full text-center cint-used-input" min="0" readonly style="background-color:#f0f0f0;"></td>
        <td><input type="number" class="input-full text-center ram-used-input" min="0" readonly style="background-color:#f0f0f0;"></td>
        <td>
            <div class="inline-evidence-cell">
                ...
                <tbody>
                    ${normalizedRows.map(row => {
                        ...
                        <tr class="mariadb-custom-proposal-row" data-component="${escapeHtml(row.component)}">
                            ...
                            <td><textarea class="input-full mariadb-custom-proposal-config" rows="4" style="resize:none;overflow:hidden;${lockedStyle}" oninput="autoResizeCustomProposalTextarea(this)" placeholder="Mỗi dòng là một thông số cấu hình" ${readOnlyAttr}>${escapeHtml(row.configurationText)}</textarea></td>
...
function buildRedisCustomProposalSectionHtml(selectedProposalSource, customProposalTable) {
    ...
    const buildRows = () => rows.map(row => `
        <tr>
            ...
            <td><textarea class="input-full redis-custom-proposal-config sizing-user-input" rows="4" style="resize:none;overflow:hidden;" oninput="autoResizeCustomProposalTextarea(this)" placeholder="Mỗi dòng là một thông số cấu hình, ví dụ:&#10;16 vCPU&#10;64 GB RAM&#10;256 GB DISK">${escapeHtml(row.configurationText)}</textarea></td>
...
function addAppCustomProposalRow(sourceOrData = {}, rowData = null) {
    ...
    tr.innerHTML = `
        ...
        <td>
            <textarea class="input-full app-custom-proposal-config sizing-user-input" rows="4" style="resize:none;overflow:hidden;" oninput="autoResizeCustomProposalTextarea(this)" placeholder="Mỗi dòng là một thông số cấu hình, ví dụ:&#10;CPU: = 16 Cint&#10;RAM: = 64 GB">${escapeHtml(normalizedData.configurationText)}</textarea>
        </td>
        <td class="text-center">
...
function addInputConfigRow() {
    ...
    tr.innerHTML = `
        ...
        <td>
            <input type="number" class="input-full text-center cint-used-input" min="0" readonly style="background-color: #f0f0f0;">
        </td>

        <td>
            <input type="number" class="input-full text-center ram-used-input" min="0" readonly style="background-color: #f0f0f0;">
        </td>
...
function addK8SInputConfigRow() {
    ...
    tr.innerHTML = `
        ...
        <td><input type="number" class="input-full text-center k8s-cint-used-input" min="0" readonly style="background-color: #f0f0f0;"></td>
        <td><input type="number" class="input-full text-center k8s-ram-used-input" min="0" readonly style="background-color: #f0f0f0;"></td>
        <td>
            <div class="inline-evidence-cell">
                ...
                <tbody>
                    ${normalizedRows.map(row => `
                        <tr class="k8s-custom-proposal-row" data-component="${escapeHtml(row.component)}">
                            <td><strong>${escapeHtml(row.component)}</strong></td>
                            <td><textarea class="input-full k8s-custom-proposal-config" rows="4" style="resize:none;overflow:hidden;" oninput="autoResizeCustomProposalTextarea(this)" placeholder="Mỗi dòng là một thông số cấu hình">${escapeHtml(row.configurationText)}</textarea></td>
        ...
        <div class="lbfw-custom-proposal-section" style="${normalizedSource === 'custom' ? '' : 'display:none;'}">
            ...
            <table class="sizing-table lbfw-custom-proposal-table" data-lbfw-custom-proposal-table="1" style="margin-top:8px;">
                ...
                <tbody>
                    <tr>
                        <td><strong>FW/LB</strong></td>
                        <td><textarea class="input-full lbfw-custom-proposal-config" rows="3" style="resize:none;overflow:hidden;" oninput="autoResizeCustomProposalTextarea(this)" placeholder="Ví dụ: Thông lượng < 2.5000 Gbps">${escapeHtml(normalizedTable.configurationText)}</textarea></td>
